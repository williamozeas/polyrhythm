...
public class SpecialAudioFunctions : MonoBehaviour
{
    ...
    private GameSettings[] IntroSettings = {
        new GameSettings(0.012f, 0, 0.7f, 0.01f, 0.008f), //0
        new GameSettings(0.011f, 0, 0.7f, 0.01f, 0.008f), //0.1
        new GameSettings(0.01f, 0, 0.5f, 0.01f, 0.008f), //0.2
        new GameSettings(0.009f, 0, 0.5f, 0.01f, 0.008f), //0.3
        new GameSettings(0.008f, 0, 0.45f, 0.01f, 0.008f), //0.4
        new GameSettings(0.0075f, 0, 0.45f, 0.015f, 0.008f), //0.5
        new GameSettings(0.007f, 0, 0.4f, 0.015f, 0.008f), //0.6
        new GameSettings(0.006f, 0, 0.4f, 0.015f, 0.008f), //0.7
