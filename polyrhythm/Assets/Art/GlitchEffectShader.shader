Shader "Custom/GlitchEffectShader"
{
    Properties
    {
        ...
        _ChromAberrAmountX("Chromatic aberration amount X", float) = 0.5
        _ChromAberrAmountY("Chromatic aberration amount Y", float) = 0.5
        ...
        _GlitchEffect("Glitch effect", float) = 0.7
    }
    SubShader
    {
        // No culling or depth
